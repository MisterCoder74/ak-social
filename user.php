...
if($u == $log_username && $user_ok == true){
	...
	$avatar_form .=   '<br><center>Change your avatar</center><br>';
	$avatar_form .=   '<label class="custom-file-upload"><input type="file" name="avatar" required />Choose a file</label>';
	$avatar_form .=   '<br><input type="submit" value="Upload">';
	$avatar_form .= '</form>';
}
...
if($avatar == NULL){
	$profile_pic = '<img src="images/avatardefault.png" alt="'.$u.'">';
}
?><?php
$isFriend = false;
...
if($friend_count < 1){
	...
	while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
		...
		$friendsHTML .= '<div>'.$friend_username.'<br><a href="user.php?u='.$friend_username.'"><img class="friendpics" src="'.$friend_pic.'" alt="'.$friend_username.'" title="'.$friend_username.'"></a></div>';
	}
}
?><?php 
$coverpic = "";
...
if(mysqli_num_rows($query) > 0){
	...
	$filename = $row[0];
	$coverpic = '<img src="user/'.$u.'/'.$filename.'" alt="user picture">';
}
?>
<!DOCTYPE html>
<html>
...
<div id="midleft">
<center><h1><?php echo $u."'s Details"; ?></h1></center><br>
<details open>
  <summary><span id="summaryname">User: <?php echo $u; ?></span></summary>
  <p>Is the viewer the page owner, logged in and verified? <?php echo $isOwner; ?></p>
  ...
  <hr>
  <br>
<center><h1><?php echo $u."'s Images"; ?></h1></center><br>
  <div id="profile_pic_box"><?php echo $profile_pic; ?><br><?php echo $avatar_form; ?></div>
 <br>
 <center><h1><?php echo $u."'s Gallery"; ?></h1></center><br>
...
<div id="pageMiddle">
<!-- Only user's statuses  -->
 <center><h1><?php echo $u."'s Diary Board"; ?></h1></center><br>
...
<div id="midright">
<center><h2><?php echo $u."'s Friend List"; ?></h2></center><br>
<div id="frienlistdiv">
